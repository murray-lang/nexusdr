...
set(PLATFORM_APP_DIR ${CMAKE_SOURCE_DIR}/src/app/stm32h745i)

set(CM4_BINARY_DIR ${CMAKE_BINARY_DIR}/CM4)
set(CM7_BINARY_DIR ${CMAKE_BINARY_DIR}/CM7)

add_subdirectory(${PLATFORM_APP_DIR}/CM7 ${CM7_BINARY_DIR} )
add_subdirectory(${PLATFORM_APP_DIR}/CM4 ${CM4_BINARY_DIR} )
